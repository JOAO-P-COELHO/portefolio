...
useEffect(() => {
  ...
  return (
    <div id="div1" className="content">
      ...
      <div id="central" className="d-flex justify-content-center">

        
        <div class="container left align-self-center">
        <h1 id="talk" datatext="Hi. I'm João P. Coelho.">Hi. I'm João P. Coelho.</h1>
          <img src={myImg} alt="My Image" id="my_img"/>
        </div>

        <div class="container right align-self-center  ">
        <div className='container  ' id="mystack">
          <div className='d-flex justify-content-center ' id="text_stack">
            <h1>I work with: </h1> 
          </div>
          <h2 id="stack_ref" className='p_stack_text d-flex justify-content-center'>
          {stack[num]}
          </h2>
          <div className='container' id="icons"> 
            ...
            <div align="center" class="container">
              ...
              {/*Boot */}<svg id="bootstrap" className='col-6 col-sm-3 ' xmlns="http://www.w3.org/2000/svg" class="bi bi-bootstrap-fill icon" viewBox="0 0 16 16">
            ...
            <div align="center" class="container"> 
              ...
              {/* Jquery<span id="jquery" class="ui-icon ui-icon-jquery icon"></span> */}
